...
export default function UsuariosAdmin() {
  ...
  const [usuarios, setUsuarios] = useState([
    { id: 1, nombre: "Daniel Quispe", rol: "Admin", correo: "d.quispe@profe.edu.pe", score: 100, plan: "N/A", quejas: 0 },
    { id: 2, nombre: "Ana Silva", rol: "Estudiante", correo: "asilva@profe.edu.pe", score: 95, plan: "N/A", quejas: 0 },
    { id: 3, nombre: "Carlos Gómez", rol: "Profesor", correo: "cgomez@profe.edu.pe", score: 85, plan: "Premium", quejas: 0 },
    { id: 4, nombre: "Luis Ramírez", rol: "Profesor", correo: "lramirez@profe.edu.pe", score: 45, plan: "Gratuito", quejas: 2 },
    { id: 5, nombre: "María Torres", rol: "Estudiante", correo: "mtorres@profe.edu.pe", score: 65, plan: "N/A", quejas: 1 },
  ]);
  ...
  const guardarUsuario = (e) => {
    ...
    if (editandoId) {
      ...
      const nuevoUsuario = { id: Date.now(), quejas: 0, ...formData };
    ...
    <div className="d-flex">
      ...
      <div className="container-fluid p-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', overflowX: 'hidden' }}>
        ...
        <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
          <div>
            <h2 className="fw-bold mb-1" style={{ color: '#3F51B5' }}>Directorio de Usuarios</h2>
            <p className="text-muted small mb-0">Gestiona cuentas, planes y audita el Score de Confiabilidad.</p>
          </div>
          <button className="btn text-white fw-semibold shadow-sm px-4 d-flex align-items-center gap-2" style={{ backgroundColor: '#7B1FA2' }} onClick={() => abrirModal()}>
            + Agregar Usuario
          </button>
        </div>
          ...
          <div className="card-body p-3">
            <div className="input-group">
              ...
              <input 
                ...
                placeholder="Buscar por nombre, correo o código institucional..." 
                value={busqueda} 
        ...
        <div className="card border-0 shadow-sm bg-white" style={{ borderRadius: '15px' }}>
          <div className="card-body p-4">
            <h5 className="fw-bold text-dark mb-3">👥 Cuentas Registradas</h5>
                  ...
                  {usuariosFiltrados.length > 0 ? (
                    usuariosFiltrados.map(u => (
                      <tr key={u.id}>
                        ...
                        <td>
                          {u.rol === 'Profesor' && (
                            <span className={`badge me-2 px-2 py-1 ${u.plan === 'Premium' ? 'bg-warning text-dark border border-warning' : 'bg-light text-dark border'}`}>
                        ...
                        <td className="text-end pe-3">
                          <button className="btn btn-sm btn-outline-primary fw-bold me-2 px-3 rounded-pill" onClick={() => abrirModal(u)}>Editar</button>
                          <button className="btn btn-sm btn-outline-danger px-3 rounded-pill" onClick={() => eliminarUsuario(u.id)}>Bloquear</button>
                        </td>
                      </tr>
                    ))
                  ) : (
            ...
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '15px', overflow: 'hidden' }}>
              ...
              <form onSubmit={guardarUsuario}>
                <div className="modal-body p-4 bg-white">
                  ...
                  <div className="row">
                    <div className="col-6 mb-3">
                      ...
                      <select name="rol" className="form-select bg-light border-0" value={formData.rol} onChange={handleInputChange}>
                  ...
                  {formData.rol === 'Profesor' && (
                    <div className="mb-3 p-3 rounded" style={{ backgroundColor: 'rgba(212, 175, 55, 0.1)' }}>
                      <label className="form-label small fw-bold" style={{ color: '#D4AF37' }}>⭐ Plan de Suscripción (Profesor)</label>
                      <select name="plan" className="form-select border-warning" value={formData.plan} onChange={handleInputChange}>
                ...
                <div className="modal-footer border-0 bg-light">
                  ...
                  <button type="submit" className="btn text-white px-4 fw-semibold rounded-pill" style={{ backgroundColor: '#7B1FA2' }}>
