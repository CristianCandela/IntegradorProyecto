      ...
      <div className="row g-0 min-vh-100">
        ...
        <div className="col-lg-6 d-none d-lg-block p-0 position-relative">
          ...
          <div className="position-absolute bottom-0 start-0 p-5 w-100" 
            ...
            <div className="row g-4">
              <div className="col-6">
                <div className="glass-effect round-xl p-3 text-center text-white">
                  <i className="bi bi-shield-check fs-2 d-block mb-2 text-purple-light"></i>
                  <small className="fw-bold">100% Seguro</small>
                </div>
              </div>
              <div className="col-6">
                <div className="glass-effect round-xl p-3 text-center text-white">
                  <i className="bi bi-people fs-2 d-block mb-2 text-purple-light"></i>
        ...
        <div className="col-lg-6 d-flex align-items-center justify-content-center position-relative px-3 px-md-4 py-5">
          ...
          <div className="position-absolute top-0 end-0 p-3 p-md-4">
            ...
            <Link to="/login" className="ms-2 fw-bold text-decoration-none small hover-link text-violet-main">
              Inicia sesión
            </Link>
          </div>

          {/* Tarjeta de registro */}
          <div className={`registro-card p-4 p-md-5 shadow-2xl round-2xl bg-white w-100 position-relative ${isAnimating ? 'role-swap' : ''}`} 
                ...
                {Object.keys(roleOptions).map((r) => (
                  <div className="col" key={r}>
                    <button
                      ...
                      className={`role-btn w-100 py-3 round-xl border-0 d-flex align-items-center justify-content-center gap-2 transition-all ${role === r ? 'active' : ''}`}
                      style={{
            ...
            <div className="text-center mb-4">
              <div className="icon-badge-mx-auto mb-3 shadow-lg round-xl p-3 d-inline-block" 
                   style={{ backgroundColor: currentRole.color }}>
                <i className={`bi ${currentRole.icon} fs-3 text-white`}></i>
              </div>
              <h2 className="fw-bold text-dark mb-1">Crear cuenta</h2>
              <p className="text-muted small mb-0">Registro para <strong className="text-capitalize text-violet-main">{currentRole.title}</strong></p>
            ...
            <form onSubmit={handleRegister} className="mb-4">
              <div className="row g-3">
                {currentRole.fields.map((field) => (
                  <div className="col-12" key={field.name}>
                    <label className="form-label small fw-bold text-dark-blue mb-2">
                      {field.label}
                    </label>
              ...
              <div className="form-check mt-4 mb-4">
                ...
                <label className="form-check-label small text-muted" htmlFor="terms">
                  Acepto los <a href="#!" className="text-violet-main fw-bold text-decoration-none">términos y condiciones</a> y la <a href="#!" className="text-violet-main fw-bold text-decoration-none">política de privacidad</a>
                </label>
              </div>
              ...
              <div className="d-grid gap-3">
                <button 
                  type="submit" 
                  className="btn btn-register py-3 shadow-lg border-0 round-xl fw-bold text-white"
                  disabled={isLoading}
                  style={{
            ...
            <div className="row g-2 mb-3">
              <div className="col-6">
                <button className="btn btn-outline-secondary w-100 py-2 round-lg border d-flex align-items-center justify-content-center gap-2">
            ...
            {/* Info adicional */}
            <div className="text-center mt-4 p-3 round-xl bg-light-soft">
              <p className="small text-muted mb-2">
                <i className="bi bi-info-circle me-2 text-violet-main"></i>
